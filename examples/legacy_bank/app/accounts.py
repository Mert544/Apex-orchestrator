...
This legacy-banking module deliberately contains known security and
quality defects (marked with ``# KNOWN ISSUE``) so Apex's detectors and
fix transforms have a realistic target to find and repair. It is
defensive test data that exercises a code-analysis tool — not production
code, and not an exploit.
"""
