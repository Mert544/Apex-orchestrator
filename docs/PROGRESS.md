...
- **ERTELENEN:** dream `--learn-gates` cron + warm-up (dogfood.yml one-liner, hazır); goal_fixpoint `--learned-order` CLI; idea-memory warm-summary; objectives risk-tier — hepsi dispatch-hazır, sıradaki dalga.
