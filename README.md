...
`apex objectives` lists the registered objectives — **95 today, all reachable from the idea engine** — and `apex recipes` shows the transform catalog as named, composable recipes.
