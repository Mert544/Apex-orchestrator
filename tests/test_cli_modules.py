...
def test_family_parser_registration_covers_every_command():
    ...
    assert set(sub.choices) == {
        ...
        "grade", "impact", "mutants", "immune", "duplication", "brief", "dream", "intelligence", "polyglot", "readiness", "fix-risk", "discoveries", "outcomes", "recipes", "changelog", "explain", "objectives", "native-mind", "trackrecord", "scope", "js-scope", "proof", "vault", "agenda",
