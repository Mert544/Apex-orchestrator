...
def test_family_parser_registration_covers_every_command():
    ...
    assert set(sub.choices) == {
        ...
        "grade", "impact", "mutants", "duplication", "brief", "dream", "outcomes", "recipes", "changelog", "explain", "objectives", "trackrecord", "scope",
        ...
        "dashboard", "hotspots", "deadcode", "city", "report", "fractal", "debug", "pulse",
