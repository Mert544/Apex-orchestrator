...
def test_family_parser_registration_covers_every_command():
    ...
    assert set(sub.choices) == {
        ...
        "quickstart", "grade", "impact", "mutants", "immune", "manifesto", "duplication", "brief", "dream", "intelligence", "polyglot", "readiness", "fix-risk", "discoveries", "outcomes", "recipes", "changelog", "explain", "objectives", "native-mind", "trackrecord", "scope", "js-scope", "proof", "vault", "agenda",
